...
public class SanPhamGUI extends javax.swing.JFrame {
    ...
    public SanPhamGUI() {
        ...
        tbModel = (DefaultTableModel) jTableSP.getModel();
        jTableSP.setRowHeight(20);

        ProductLineBUS bus = new ProductLineBUS();
        ProductInstanceBUS prodIns_bus = new ProductInstanceBUS();
        ArrayList<ProductLineDTO> temp = bus.getDS();
        ArrayList<ProductInstanceDTO> prodIns_temp = prodIns_bus.getDSSanphamdaydu();

        for (ProductLineDTO dto : temp) {
            tbModel.addRow(new Object[]{
                dto.getProductLineID(),
                dto.getName(),
                (int) dto.getPrice(),
                dto.getStock()
            });
            jTableSP.setModel(tbModel);
    ...
    private void initComponents() {
        ...
        jTableSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã ProductLine", "Tên ProductLine", "Giá", "Số lượng"
            }
        ) {
    ...
    public void SanPham() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                SP_GUI.setLocationRelativeTo(null);
            }
        });
    }
